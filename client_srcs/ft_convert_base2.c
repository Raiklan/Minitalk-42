...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/11/04 22:28:05 by saich             #+#    #+#             */
/*   Updated: 2021/11/04 22:28:07 by saich            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	in_base_here(char str, char *base, int z)
{
	int	i;
...
static int	ft_next(char *str, int z)
{
	int	i;
	int	moins;
